...
macro( my_add_precompiled_headers TARGET PRECOMPILED_HEADER )
	...
	get_target_property( _target_pic ${TARGET} POSITION_INDEPENDENT_CODE )
	if ( _target_pic )
		set( _pic_flags )
		if ( "${_target_type}" STREQUAL "EXECUTABLE" )
			set( _pic_flags ${CMAKE_CXX_COMPILE_OPTIONS_PIE} )
		endif()
		if ( NOT _pic_flags )
			set( _pic_flags ${CMAKE_CXX_COMPILE_OPTIONS_PIC} )
		endif()
		list( APPEND _additional_flags ${_pic_flags} )
	endif()

	# gathering include information into _include_flags
	set( _include_flags )
	get_directory_property( _include_directories INCLUDE_DIRECTORIES )
	get_target_property( _target_include_directories ${TARGET} INCLUDE_DIRECTORIES )
	foreach ( _include ${_include_directories} ${_target_include_directories} )
		if ( MSVC )
	...
	get_directory_property( _build_type_definitions "COMPILE_DEFINITIONS_${_build_type}" )
	get_target_property( _target_definitions ${TARGET} COMPILE_DEFINITIONS )
	get_target_property( _build_type_target_definitions ${TARGET} "COMPILE_DEFINITIONS_${_build_type}" )

	foreach( _def ${_definitions} ${_build_type_definitions}
			${_target_definitions} ${_build_type_target_definitions} )
